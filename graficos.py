...
def GeraGraficoEntrada(periodo, dados, Papel, toque):
    ...
    dir= 'C:/Users/Nob/Documents/Workspace/AnaliseFinanceira/imagens/'
    ...
    mpf.plot(
        ...
        hlines=dict(hlines=[topo, fundo, r050, r061, p100], colors=['#000000', '#000000', '#FF0000', '#FF00FF', '#008000'] , linestyle='dashed', linewidths=[1,1,1,1,2]),
        volume=True, 
        )
